...
class HeapImpl{
    ...
    public int getMax(){    //We see the first index of array to see max
        return arr[0];
    }

    public int removeMax(){
        int max=arr[0];             //max=arr[0]
        arr[0]=arr[size-1];         //shift last element of array to first
        size=size-1;                //decrease size of array by 1
